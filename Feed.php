...
<body><div class="box"><a id="lg" href="profile.php"><h6>Back</h6></a><div id="sticky"><form method="post"><input placeholder='Search Your Downloads' name="val" type="text"><input id="sub" class="btn-primary" name="submit" type="submit" value="search"></form></div>
     <?php
     if(isset($_POST['submit'])){
      $val=$_POST['val'];
      $val='%'.$val.'%';
      $q="select * from downloads where filename LIKE '$val' or subject LIKE '$val' ORDER BY Time DESC";
